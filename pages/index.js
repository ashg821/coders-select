...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Coders Select - Wear your code</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className='w-100 relative' style={{ height: "100vh" }}>
        <img src="/hero-img.jpg" className="w-100 h-100" style={{ objectFit: 'cover' }} />
        <Typography variant='h1' className="font-black absolute top-50 left-1/2 -translate-y-1/2 -translate-x-1/2  text-white md:min-w-max drop-shadow" style={{ textShadow: "2px 2px 10px #000000" }}>WEAR YOUR STYLE</Typography>
      </div>
